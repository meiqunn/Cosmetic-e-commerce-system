...
.quick a:hover{letter-spacing:2px;
				font-style:italic;
				color:#565051;}
				
.address a:hover{color:#565051;
...
<!--header-->
	<div class="header">
		<a href="index.php"><img src="logo.png" alt="52Hz logo" title="52Hz logo" width="150px;" style="float:left; margin-left:10px;"></a>
...
<div class="mySlides fade">
  <img src="chanel_1.jpg" alt="slideshow picture 1" style="width:100%; height:700px; " >
...
<div class="mySlides fade">
  <img src="Velvet_1.jpg" alt="slideshow picture 2" style="width:100%; height:700px; margin-bottom:-380px;">
   <div class="slide-text" style="margin-left:60px; color:white; margin-top:385px;">
	  <h3 data-animation="bounceInDown" data-delay="0" data-duration="500ms" style="color:white; margin-top:-500px;">* Video tutorial for beginner</h3>
	  <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms">Follow Your Heart</h2>
	  <a href="tutorial.php" data-animation="fadeInUp" data-duration="500ms" class="slide-btn" >View Now</a>
  </div>
</div>

<div class="mySlides fade">
  <img src="Mac_1.jpg" alt="slideshow picture 3" style="width:100%; height:700px; margin-bottom:-380px;">
			...
			$result = mysqli_query($connect, "select * from product WHERE new_arrive=1 ");	
	         while($row = mysqli_fetch_assoc($result))
			  ...
			  <div class="column">
				...
				<img src="Admin/working_site/Product_img/<?php echo $row["img_dir"] ?>" width="300px;" class="img">
					<div class="middle">
