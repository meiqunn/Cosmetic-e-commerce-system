...
<?php if(isset($_SESSION['id']))
		{
			...
			$payid=$row["payment_id"];
				$t_result=mysqli_query($connect, "select * from customize where payment_id=$payid ");
...
<table border="1" style="margin-top:100px; border-collapse: collapse; margin-left:50px; font-size:20px;">
	<tr>
		<th></th>
		<th><img src="<?php echo $row["img_dir"] ?>"  style="background-color:<?php echo  $t_row["color"]?>" width="200px;" class="pro_img"></th>
	</tr>
	<tr>
		<th>PRODUCT NAME</th>
...
<table border="1" style="margin-top:100px; border-collapse: collapse; margin-left:50px; font-size:20px;">
	<tr>
		<th></th>
		<th><img src="Admin/working_site/Product_img/<?php echo $row["img_dir"] ?>" width="200px;" class="pro_img"></th>
	</tr>
	<tr>
		<th>PRODUCT NAME</th>
		<td><?php echo $row["product_name"] ?></td>
