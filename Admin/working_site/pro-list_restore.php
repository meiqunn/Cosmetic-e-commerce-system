...
<head>
    ...
    <title> 52Hz | Restore Record </title>
...
<body class="fix-header card-no-border fix-sidebar">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Restore record</li>
	...
	<table class="pro-list">
			 ...
			 <?php
							...
							$p_result = mysqli_query($connect, "select product.* ,product_type.* from product_type,product WHERE product.product_id=product_type.product_id and product_type.product_isDelete=1"); 
							...
							while($p_row = mysqli_fetch_assoc($p_result))
							{
                                ...
                                {
                                var option;
                                option=confirm("do you want to delete this product forever?");
                                return option;
                                }
                                </script>
                                <thead>
                                ...
                                <td style="padding-left:30px; padding-bottom:50px;"><a href="pro-list_restore.php?delete&procode=<?php echo $p_row['product_type_id'];?>" onclick="return del_confirmation();">Delete</a></td>
                                <td style="padding-left:12px; padding-bottom:50px;"><a href="pro-list_restore.php?restore&procode=<?php echo $p_row['product_type_id'];?>" onclick="return confirmation();">Restore</a></td>
...
{
	$pcode=$_GET["procode"];
	mysqli_query($connect,"UPDATE product_type SET product_isDelete=0 where product_type_id='$pcode'");

?>
	<script>
	alert("This product has been restore!");
	window.location.assign("pro-list_restore.php");
	</script>
	<?php
}
...
{
	$pcode=$_GET["procode"];
	mysqli_query($connect,"delete from product_type where product_type_id='$pcode'");
