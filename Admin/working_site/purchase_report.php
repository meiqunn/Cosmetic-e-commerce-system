        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
					...
					<div style="text-align:right"><a href="xls.php">download</a></div>
                <!-- ============================================================== -->
...
while($user_row = mysqli_fetch_assoc($user_result))
{
	?>
		...
		<tr>
			...
			<td><?php echo $user_row["product_type_price"]*$user_row["product_qty"]?></td>
			<td><?php echo 0.40*($user_row["product_type_price"]*$user_row["product_qty"])?></td>
...
{
	$payid=$_GET["payid"];
	mysqli_query($connect,"UPDATE purchase_history SET history_isDelete=1 where payment_id='$payid'");
	?>
		<script>
