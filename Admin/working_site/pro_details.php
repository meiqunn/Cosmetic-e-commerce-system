    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				...
				{
					$pcode = $_GET["procode"];
					$result = mysqli_query($connect, "select * from product where product_id='$pcode' and product_isDelete=0");
                    $row = mysqli_fetch_assoc($result);
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <table class="table">
                                        <tbody>  
											<tr>
                                               <img src="Product_img/<?php echo $row["img_dir"]?>" width="150px" style="margin-left:190px">
                                            </tr>
                                            <tr>
                                                <td><b>Product ID:</b></td>
                                                <td><input type="text" name="prod_id" size="20px" value="<?php echo $row["product_id"]?>" readonly></td>
                                            </tr>
                                            <tr>
											...
											<tr>
                                                ...
                                                <td><input type="text" name="price" size="5px" value="<?php echo $row["product_price"]?>" readonly></td>
                                            </tr>
											<tr>
											...
											<tr>
                                                <td><b>Product Type: </b></td> 
												 <td>
												<?php 
												$p_result = mysqli_query($connect, "select * from product_type where product_id='$pcode' and product_isDelete=0");
												while($p_row = mysqli_fetch_assoc($p_result))
												{
												?>
												<div style="margin:10px;display:inline-block" >
													<a style="color:black" href="details.php?view&procode=<?php echo $p_row["product_type_id"] ?> ">
														<img src="Product_img/<?php echo $p_row["img_dir"]?>" width="150px">
														<div style="display:block">
															<input type="text" name="pcategory" size="40px" value="<?php echo $p_row["product_type_name"]?>" readonly> 
													   </div>
													</a>
												</div>
												<?php
												...
												?>
												<div style="margin:10px;display:block;font-size:15px" >
												<b><a href="add.php?add&prod_id=<?php echo $pcode?>" >Add New Product Type</a></b>
												</div>
												</td>
                                            </tr>  
                                        </tbody>
