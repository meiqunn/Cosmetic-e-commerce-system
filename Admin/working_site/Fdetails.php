    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				...
				{
					$name = $_GET["user"];
					$result = mysqli_query($connect, "SELECT * from contact_us WHERE name = '$name'");
					$row = mysqli_fetch_assoc($result);
				}
				?>
                    <!-- column -->
                                ...
                                <form action="" method="GET">
                                    <table class="table">
                                        <tbody>   
                                            <tr>
                                                <td><b>Full Name </b></td>
                                                <td><input type="text" name="username" size="10px" value="<?php echo $row["name"]?>" readonly></td>
                                            </tr>
                                            <tr>
                                                <td><b>User Email </b></td> 
                                                <td><input type="text" name="uemail" size="30px" value="<?php echo $row["email"]?>" readonly></td> 
                                            </tr>   
											<tr>
                                                <td><b>Phone Number </b></td> 
                                                <td><input type="text" name="pn" size="10px" value="<?php echo $row["phone_number"]?>" readonly></td> 
                                            </tr>  											
                                            <tr>
                                                <td><b>Subject </b></td> 
                                                <td><input type="text" name="subject" size="20px" value="<?php echo $row["subject"]?>" readonly></td>
                                            </tr>
											<tr>
                                                <td><b>Message</b></td> 
                                                <td><input type="text" name="message" size="80px" value="<?php echo $row["message"]?>" readonly></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </form>
