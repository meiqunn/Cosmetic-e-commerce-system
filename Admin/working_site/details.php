...
<head>
    ...
    <title>52Hz | Product Details</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				...
				if(isset($_GET['view']))
				{
					...
					$p_result = mysqli_query($connect, "select * from product_type where product_type_id='$pcode' ");
                        ...
                        <div class="card">
                            ...
                            <form action="" method="GET">
                                    <table class="table">
                                        <tbody>   
											<tr>
                                               <img src="Product_img/<?php echo $p_row["img_dir"]?>" width="150px" style="margin-left:15px">
                                            </tr>
                                            <tr>
                                                <td><b>Product ID:</b></td>
                                                <td><input type="text" name="prod_id" size="20px" value="<?php echo $p_row["product_id"]?>" readonly></td>
                                            </tr>
											<tr>
                                                <td><b>Product Type ID:</b></td>
                                                <td><input type="text" name="prod_id" size="20px" value="<?php echo $row["product_type_id"]?>" readonly></td>
                                            </tr>
                                            <tr>
                                                <td><b>Product Name: </b></td> 
                                                <td><input type="text" name="pname" size="50px" value="<?php echo $row["product_name"]?>" readonly></td> 
                                            </tr>  
											<tr>
                                                <td><b>Product Type Name: </b></td> 
                                                <td><input type="text" name="pname" size="50px" value="<?php echo $row["product_type_name"]?>" readonly></td> 
                                            </tr>
                                            <tr>
                                                <td><b>Product Description </b></td> 
                                                <td><input type="text" name="pdes" size="80px" value="<?php echo $row["product_description"]?>" readonly></td>
                                            </tr>
											<tr>
                                                <td><b>Product Price </b></td> 
                                                <td><input type="text" name="price" size="5px" value="<?php echo $row["product_type_price"]?>" readonly></td>
                                            </tr>
											<tr>
                                                <td><b>Product Category: </b></td> 
                                                <td><input type="text" name="pcategory" size="5px" value="<?php echo $row["product_category"]?>" readonly></td> 
                                            </tr>  
											<tr>
                                                <td><b>Product Stock: </b></td> 
                                                <td><input type="text" name="pstock" size="5px" value="<?php echo $row["product_stock"]?>" readonly></td> 
                                            </tr> 
                                        </tbody>
                                    </table>
                                </form>
