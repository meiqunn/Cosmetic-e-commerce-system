...
if(isset($_GET["forgotbtn"]))
{
		...
		$result=mysqli_query($connect, "SELECT * FROM admin WHERE admin_email='$email' AND admin_phone='$phonenum'");
		...
		if($count!=0)
		{
			...
			$name=$row['admin_name'];
			//the subject
			$sub = "Admin Account Recovery Link";
			//the message
			$msg = "Hi our dear admin,".$name.".You Account Password is being reset. Here is your Reset Link http://localhost/fyp/Admin/working_site/forgotchange.php?reset&cusid=$cusId";
		...
		<form method="get" name="logform">
			<div class="sign-in-htm">
				...
				<div class="group">
					...
					<input id="pass_error" name="pn" type="text" pattern="[0-9]{10,11}" oninvalid="this.setCustomValidity('Minimum of 10 numbers')" oninput="this.setCustomValidity('')" class="input" autocomplete="off">
