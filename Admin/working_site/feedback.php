...
<head>
    ...
    <title> 52Hz | User Feedback </title>
...
<body class="fix-header card-no-border fix-sidebar">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">User Feedback</h3>
                        <ol class="breadcrumb">
	...
	<table class="pro-list">
		<thead>
			<tr>
                ...
                <th style="padding-right:20px; padding-bottom:20px;">Full Name</th>
                <th style="padding-bottom:20px;">User Email</th>
		...
		<tbody>
			 <?php
                   ...
                   if(mysqli_num_rows($result) > 0)
                   {
                    ...
                    $result = mysqli_query($connect, "select * from contact_us LIMIT ".$page_first_result.','.$results_per_page);	
                    ...
                    <tr>
                    <td style="padding-left:30px; padding-bottom:50px;"><?php echo $row["name"] ?></td>
                    <td style="padding-right:40px; padding-bottom:50px;"><?php echo $row["email"] ?></td>
					<td style="padding-right:40px; padding-bottom:50px;"><?php echo $row["subject"] ?></td>
                    <td style="padding-right:40px; padding-bottom:50px;"><a href="Fdetails.php?view&user=<?php echo $row['name'];?>">More details</a></td>
                    </tr>
                    <?php
    ...
    <div class="pagination">
				<a href="feedback.php?page=<?php if(($page-1)>0 ){echo ($page-1);}else{echo $page;}?>">&laquo;</a>
				<?php
				...
				{  
						...
						?>
						<a href="feedback.php?page=<?php echo $page;?>"><?php echo $page;?></a>
				...
				<a href="feedback.php?page=<?php if(($page+1)<=$number_of_page){echo ($page+1);}else{echo $page;}?>">&raquo;</a>
				</div>
</div>
                <!-- ============================================================== -->
                <!-- End PAge Content -->
