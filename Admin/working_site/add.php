                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="insert-product-type.php">Product Type List</a></li>
                                    ...
                                    <table class="table">
                                        <tbody>   
											...
											?>
                                                ...
                                                <td><input type="text" name="prod_id" value="<?php echo $row["product_id"]?>" readonly></td>
                                            </tr>
                                            <tr>
                                                <td><b>Product Type Name: </b></td> 
                                                <td><input type="text" name="ptypename" size="30px"></td> 
                                            </tr>                                           
                                            <tr>
                                                <td><b>Price(RM): </b></td> 
                                                <td><input type="number" name="price" size="5px" min="1"></td>
                                            </tr>
											<tr>
                                                <td><b>Product Stock: </b></td> 
                                                <td><input type="number" name="pstock" size="5px" min="1"></td> 
                                            </tr>  
											<tr>
                                                <td><b>Product Picture: </b></td> 
												<td><input type="file" name="choosefile" />
...
if(isset($_POST['btn_submit']) )	
{
	...
	$product=mysqli_query($connect, "Select count(*) from product_type where product_type_name like '$ptypename'");
	...
	if($ptypename == "")
	{
		?>
		<script>
			alert("Details havent fill up completely.")
		</script>
		<?php
	}
	else
	{
		...
		if($repeat==0)
		{
			mysqli_query($connect,"INSERT INTO product_type(product_id, product_type_name, product_type_price, product_stock, img_dir) VALUES ('$prod_id', '$ptypename', '$price', '$pstock', '$img')");
			?>
			<script>
		...
		else
		{
			?>
			<script>
			alert("Product type name had been used! Please enter a new product name that not had been used!");
			</script>
			<?php
		}
	}
