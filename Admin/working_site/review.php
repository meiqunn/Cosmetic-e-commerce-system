            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">User Review</h3>
                        <ol class="breadcrumb">
	...
	<table class="pro-list">
		<thead>
			<tr>
                ...
                <th style="padding-right:20px; padding-bottom:20px;">Review ID</th>
                <th style="padding-bottom:20px;">Product Type Name</th>
				<th style="padding-bottom:20px;padding-left:50px;">Customer Name</th>
				<th style="padding-bottom:20px; padding-left:80px;">Time </th>
				<th style="padding-bottom:20px; padding-left:80px;">Content </th>
			</tr>
		</thead>
		<tbody>
			 <?php
                   ...
                   if(mysqli_num_rows($result) > 0)
                   {
                    ...
                    $result = mysqli_query($connect, "select * from customer_review ORDER BY review_id DESC LIMIT ".$page_first_result.','.$results_per_page);	
                    ...
                    <tr>
                    <td style="padding-left:30px; padding-bottom:50px;"><?php echo $row["review_id"] ?></td>
                    <td style="padding-left:20px; padding-bottom:50px;"><?php echo $row["product_type_name"] ?></td>
					<td style="padding-left:50px; padding-bottom:50px;"><?php echo $row["customer_name"] ?></td>
					<td style="padding-left:80px; padding-bottom:50px;"><?php echo $row["time"] ?></td>
					<td style="padding-left:80px; padding-bottom:50px;"><?php echo $row["review"] ?></td>
                    </tr>
                    <?php
