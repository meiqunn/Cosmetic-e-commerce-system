...
<body>
<a href="index.php"><img src="logo.png" width="100px;" style="float:left; margin-left:10px; margin-top:-25px;"></a>
...
<tr>
		...
		<th width="44%"><img src="sean.jpg" alt="Khoo Chong Qin" width="300px;" style="margin-left:-100px; padding:10px 10px;"></th>
...
<table>			
<tr>
		<th  colspan="2" width="1300px" ><h3 style="margin-right:615px;">TEY MEI QUN</h3><br><p style="text-align:left;margin-left:100px"> My responsibility is to make our website executed more fluently. Also distribute and guide the work for other collegues.</p ></th>
		<th><img src="mg.jpg" alt="Tey Mei Qun" width="300px" style="padding:10px 10px; padding-left:20px; margin-left:100px; margin-right:100px;"></th>
		<th></th>		
</tr>
</table>		
...
<tr>
		...
		<th width="44%"><img src="yin.jpg" alt="Kong Zi Yin" width="300px;" style="margin-left:-100px; padding:10px 10px;"></th>
