...
<div class="user_info">
	<h2 class="info">CONTACT INFO </h2>
		...
		?>
			...
			<div ><input type="text" name="postal" class="name_frm" value="<?php echo $row_add['user_name']; ?>"></div>
			
			<p class="label" style="margin-left:350px; margin-top:-75px;">Contact Number</p>
			<div style="margin-left:350px;"><input type="text" name="state" class="name_frm" value="<?php echo $row_add['phone_num']; ?>"></div>
			
			<p class="label">Email</p>
			<input type="email" name="email" class="user_email" value="<?php echo $row_add['user_email']; ?>">
			
			<p class="label" class="user_address">Address</p>
			<input type="text" name="address" class="user_email" value="<?php echo $row_add["user_address"];?>">
						
			<p class="label">Postal</p>
			<div ><input type="text" name="postal" class="address_frm" pattern="[0-9]{1,5}" title="Five Number Postal Code" value="<?php echo $row_add['postal']; ?>"></div>
			
			<p class="label" style="margin-left:240px; margin-top:-75px;">State</p>
			<div style="margin-left:240px;">
				<select name="state" class="address_frm"> 
			...
			<div style="margin-left:480px;">
					<select name="city" class="address_frm" > 
		...
		<h2 class="info" style="margin-left:800px; margin-top:-478px;">ORDER SUMMARY </h2>
			<tr>
				...
				<!--<td name="price"><?php echo $row["product_price"] ?></td>-->
...
if (isset($_GET['checkout']))
{
	...
	<script>
		window.location.href="updateinfo.php?userid=<?php echo $user ?>&address= <?php echo $address ?>";
	</script>
